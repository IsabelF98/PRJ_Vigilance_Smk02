...
echo "auto-generated by afni_proc.py, Tue Nov 17 16:45:15 2020"
echo "(version 7.12, April 14, 2020)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef SC02_Preproc_fMRI.sub-S16.sh |& tee output.SC02_Preproc_fMRI.sub-S16.sh
# to execute via bash: 
#   tcsh -xef SC02_Preproc_fMRI.sub-S16.sh 2>&1 | tee output.SC02_Preproc_fMRI.sub-S16.sh
...
set output_dir = /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S16/D02_Preproc_fMRI
...
3dcopy                                                                                             \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D01_Anatomical/anatSS.sub-S16.nii.gz \
    $output_dir/anatSS.sub-S16

# copy anatomical follower datasets into the results dir
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D01_Anatomical/anatUAC.sub-S16.nii.gz \
    $output_dir/copy_af_anat_w_skull
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S16/SUMA/aparc.a2009s+aseg.nii.gz       \
    $output_dir/copy_af_aaseg
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S16/SUMA/aparc.a2009s+aseg.nii.gz       \
    $output_dir/copy_af_aeseg
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S16/SUMA/fs_ap_latvent.nii.gz           \
    $output_dir/copy_af_FSvent
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S16/SUMA/fs_ap_wm.nii.gz                \
    $output_dir/copy_af_FSWe

# copy external -tlrc_NL_warped_dsets datasets
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D01_Anatomical/anatQQ.sub-S16.nii.gz      \
    $output_dir/anatQQ.sub-S16
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D01_Anatomical/anatQQ.sub-S16.aff12.1D    \
    $output_dir/anatQQ.sub-S16.aff12.1D
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D01_Anatomical/anatQQ.sub-S16_WARP.nii.gz \
    $output_dir/anatQQ.sub-S16_WARP.nii.gz

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 5 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepAscending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepDescending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepRSER+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeAscending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeDescending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeRSER+orig'[5..$]'
...
# (new anat will be current anatSS.sub-S16+orig)
align_epi_anat.py -anat2epi -anat anatSS.sub-S16+orig \
       -suffix _al_junk                               \
...
# warped anat     : anatQQ.sub-S16+tlrc
# affine xform    : anatQQ.sub-S16.aff12.1D
# non-linear warp : anatQQ.sub-S16_WARP.nii.gz

# ================================= volreg =================================
# align each dset to base volume, to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f anatQQ.sub-S16+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: anatQQ.sub-S16+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                      \
               anatQQ.sub-S16.aff12.1D                                       \
               anatSS.sub-S16_al_junk_mat.aff12.1D -I                        \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc/NLtlrc
    # then apply non-linear standard-space warp
    3dNwarpApply -master anatQQ.sub-S16+tlrc -dxyz 3                         \
                 -source pb02.$subj.r$run.tshift+orig                        \
                 -nwarp "anatQQ.sub-S16_WARP.nii.gz mat.r$run.warp.aff12.1D" \
...
cat_matvec -ONELINE                                                          \
           anatQQ.sub-S16.aff12.1D                                           \
           anatSS.sub-S16_al_junk_mat.aff12.1D -I  > mat.basewarp.aff12.1D

3dNwarpApply -master anatQQ.sub-S16+tlrc -dxyz 3                             \
             -source vr_base+orig                                            \
             -nwarp "anatQQ.sub-S16_WARP.nii.gz mat.basewarp.aff12.1D"       \
             -prefix final_epi_vr_base

# create an anat_final dataset, aligned with stats
3dcopy anatQQ.sub-S16+tlrc anat_final.$subj
...
3dDetrend -polort 6 -prefix rm.noise.det -overwrite pb03.$subj.r01.volreg+tlrc
...
3dNwarpApply -source copy_af_anat_w_skull+orig                               \
             ...
             -ainterp wsinc5 -nwarp anatQQ.sub-S16_WARP.nii.gz               \
             anatQQ.sub-S16.aff12.1D                                         \
             -prefix follow_anat_anat_w_skull
3dNwarpApply -source copy_af_aaseg+orig                                      \
             -master anat_final.$subj+tlrc                                   \
             -ainterp NN -nwarp anatQQ.sub-S16_WARP.nii.gz                   \
             anatQQ.sub-S16.aff12.1D                                         \
...
3dresample -master full_mask.$subj+tlrc -input anatQQ.sub-S16+tlrc    \
...
1d_tool.py -infile motion_demean.1D -set_run_lengths 412 412 295 412 412 295 \
           -split_into_pad_runs mot_demean

1d_tool.py -infile motion_deriv.1D -set_run_lengths 412 412 295 412 412 295  \
...
foreach run ( $runs )
    ...
    1d_tool.py -censor_fill_parent rm.censor.r$run.1D                        \
        ...
        -write -                                                             \
      | 1d_tool.py -set_run_lengths $tr_counts -pad_into_many_runs $run 6    \
...
if ( -e @ss_review_basic ) then
    ...
    echo "\nconsider running: \n\n    afni_open -b /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S16/D02_Preproc_fMRI/QC_$subj/index.html\n"
endif
...
#
# afni_proc.py -subj_id sub-S16 -blocks despike tshift align tlrc volreg blur                                 \
...
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepAscending+orig  \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepDescending+orig \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_SleepRSER+orig       \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeAscending+orig   \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeDescending+orig  \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S16/D00_OriginalData/sub-S16_WakeRSER+orig        \
...
#     -volreg_warp_dxyz 3 -blur_size 6.0 -mask_epi_anat yes -regress_opts_3dD                                 \
#     -jobs 32 -regress_motion_per_run -regress_ROI_PC FSvent 3                                               \
#     -regress_ROI_PC_per_run FSvent -regress_make_corr_vols aeseg FSvent                                     \
#     -regress_anaticor_fast -regress_anaticor_label FSWe                                                     \
#     -regress_censor_motion 0.25 -regress_censor_outliers 0.05                                               \
#     -regress_apply_mot_types demean deriv -regress_est_blur_epits                                           \
#     -regress_est_blur_errts -regress_bandpass 0.01 0.1 -regress_polort 5                                    \
#     -regress_run_clustsim no -html_review_style pythonic -out_dir                                           \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S16/D02_Preproc_fMRI                             \
#     -script SC02_Preproc_fMRI.sub-S16.sh -volreg_compute_tsnr yes                                           \
