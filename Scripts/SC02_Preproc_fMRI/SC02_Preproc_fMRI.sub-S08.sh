...
echo "auto-generated by afni_proc.py, Tue Nov 17 16:44:33 2020"
echo "(version 7.12, April 14, 2020)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef SC02_Preproc_fMRI.sub-S08.sh |& tee output.SC02_Preproc_fMRI.sub-S08.sh
# to execute via bash: 
#   tcsh -xef SC02_Preproc_fMRI.sub-S08.sh 2>&1 | tee output.SC02_Preproc_fMRI.sub-S08.sh
...
set output_dir = /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S08/D02_Preproc_fMRI
...
3dcopy                                                                                             \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D01_Anatomical/anatSS.sub-S08.nii.gz \
    $output_dir/anatSS.sub-S08

# copy anatomical follower datasets into the results dir
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D01_Anatomical/anatUAC.sub-S08.nii.gz \
    $output_dir/copy_af_anat_w_skull
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S08/SUMA/aparc.a2009s+aseg.nii.gz       \
    $output_dir/copy_af_aaseg
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S08/SUMA/aparc.a2009s+aseg.nii.gz       \
    $output_dir/copy_af_aeseg
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S08/SUMA/fs_ap_latvent.nii.gz           \
    $output_dir/copy_af_FSvent
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S08/SUMA/fs_ap_wm.nii.gz                \
    $output_dir/copy_af_FSWe

# copy external -tlrc_NL_warped_dsets datasets
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D01_Anatomical/anatQQ.sub-S08.nii.gz      \
    $output_dir/anatQQ.sub-S08
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D01_Anatomical/anatQQ.sub-S08.aff12.1D    \
    $output_dir/anatQQ.sub-S08.aff12.1D
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D01_Anatomical/anatQQ.sub-S08_WARP.nii.gz \
    $output_dir/anatQQ.sub-S08_WARP.nii.gz

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir,
# while removing the first 5 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepAscending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepDescending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepRSER+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeAscending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeDescending+orig'[5..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat                   \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeRSER+orig'[5..$]'
...
# (new anat will be current anatSS.sub-S08+orig)
align_epi_anat.py -anat2epi -anat anatSS.sub-S08+orig \
       -suffix _al_junk                               \
...
# warped anat     : anatQQ.sub-S08+tlrc
# affine xform    : anatQQ.sub-S08.aff12.1D
# non-linear warp : anatQQ.sub-S08_WARP.nii.gz

# ================================= volreg =================================
# align each dset to base volume, to anat, warp to tlrc space

# verify that we have a +tlrc warp dataset
if ( ! -f anatQQ.sub-S08+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset: anatQQ.sub-S08+tlrc.HEAD" 
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                      \
               anatQQ.sub-S08.aff12.1D                                       \
               anatSS.sub-S08_al_junk_mat.aff12.1D -I                        \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc/NLtlrc
    # then apply non-linear standard-space warp
    3dNwarpApply -master anatQQ.sub-S08+tlrc -dxyz 3                         \
                 -source pb02.$subj.r$run.tshift+orig                        \
                 -nwarp "anatQQ.sub-S08_WARP.nii.gz mat.r$run.warp.aff12.1D" \
...
cat_matvec -ONELINE                                                          \
           anatQQ.sub-S08.aff12.1D                                           \
           anatSS.sub-S08_al_junk_mat.aff12.1D -I  > mat.basewarp.aff12.1D

3dNwarpApply -master anatQQ.sub-S08+tlrc -dxyz 3                             \
             -source vr_base+orig                                            \
             -nwarp "anatQQ.sub-S08_WARP.nii.gz mat.basewarp.aff12.1D"       \
             -prefix final_epi_vr_base

# create an anat_final dataset, aligned with stats
3dcopy anatQQ.sub-S08+tlrc anat_final.$subj
...
3dNwarpApply -source copy_af_anat_w_skull+orig                               \
             ...
             -ainterp wsinc5 -nwarp anatQQ.sub-S08_WARP.nii.gz               \
             anatQQ.sub-S08.aff12.1D                                         \
             -prefix follow_anat_anat_w_skull
3dNwarpApply -source copy_af_aaseg+orig                                      \
             -master anat_final.$subj+tlrc                                   \
             -ainterp NN -nwarp anatQQ.sub-S08_WARP.nii.gz                   \
             anatQQ.sub-S08.aff12.1D                                         \
...
3dresample -master full_mask.$subj+tlrc -input anatQQ.sub-S08+tlrc    \
...
if ( -e @ss_review_basic ) then
    ...
    echo "\nconsider running: \n\n    afni_open -b /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S08/D02_Preproc_fMRI/QC_$subj/index.html\n"
endif
...
#
# afni_proc.py -subj_id sub-S08 -blocks despike tshift align tlrc volreg blur                                 \
...
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepAscending+orig  \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepDescending+orig \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_SleepRSER+orig       \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeAscending+orig   \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeDescending+orig  \
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S08/D00_OriginalData/sub-S08_WakeRSER+orig        \
...
#     /data/SFIM_Vigilance/PRJ_Vigilance_Smk02//PrcsData/sub-S08/D02_Preproc_fMRI                             \
#     -script SC02_Preproc_fMRI.sub-S08.sh -volreg_compute_tsnr yes                                           \
