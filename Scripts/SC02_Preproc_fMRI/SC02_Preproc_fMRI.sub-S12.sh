...
echo "auto-generated by afni_proc.py, Thu Nov 19 10:27:48 2020"
...
1d_tool.py -infile motion_demean.1D -set_run_lengths 412 412 295          \
           -split_into_pad_runs mot_demean

1d_tool.py -infile motion_deriv.1D -set_run_lengths 412 412 295           \
...
foreach run ( $runs )
    ...
    1d_tool.py -censor_fill_parent rm.censor.r$run.1D                     \
        ...
        -write -                                                          \
      | 1d_tool.py -set_run_lengths $tr_counts -pad_into_many_runs $run 3 \
