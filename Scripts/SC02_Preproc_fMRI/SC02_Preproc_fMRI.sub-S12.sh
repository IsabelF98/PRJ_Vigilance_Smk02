...
3dcopy                                                                                             \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S12/D01_Anatomical/anatSS.sub-S12.nii.gz \
    $output_dir/anatSS.sub-S12

# copy anatomical follower datasets into the results dir
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S12/D01_Anatomical/anatUAC.sub-S12.nii.gz \
    $output_dir/copy_af_anat_w_skull
3dcopy                                                                                              \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S12/SUMA/aparc.a2009s+aseg.nii.gz       \
...
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S12/D01_Anatomical/anatQQ.sub-S12.nii.gz      \
...
3dcopy                                                                                                  \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S12/D01_Anatomical/anatQQ.sub-S12_WARP.nii.gz \
    $output_dir/anatQQ.sub-S12_WARP.nii.gz
...
# non-linear warp : anatQQ.sub-S12_WARP.nii.gz
...
foreach run ( $runs )
    ...
    3dNwarpApply -master anatQQ.sub-S12+tlrc -dxyz 3                         \
                 ...
                 -nwarp "anatQQ.sub-S12_WARP.nii.gz mat.r$run.warp.aff12.1D" \
...
3dNwarpApply -master anatQQ.sub-S12+tlrc -dxyz 3                             \
             -source vr_base+orig                                            \
             -nwarp "anatQQ.sub-S12_WARP.nii.gz mat.basewarp.aff12.1D"       \
...
3dNwarpApply -source copy_af_anat_w_skull+orig                               \
             ...
             -ainterp wsinc5 -nwarp anatQQ.sub-S12_WARP.nii.gz               \
             anatQQ.sub-S12.aff12.1D                                         \
             -prefix follow_anat_anat_w_skull
3dNwarpApply -source copy_af_aaseg+orig                                      \
             -master anat_final.$subj+tlrc                                   \
             -ainterp NN -nwarp anatQQ.sub-S12_WARP.nii.gz                   \
             anatQQ.sub-S12.aff12.1D                                         \
