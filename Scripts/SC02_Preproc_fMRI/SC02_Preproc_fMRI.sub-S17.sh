...
echo "auto-generated by afni_proc.py, Mon Nov 16 13:26:29 2020"
...
3dcopy                                                                                          \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S17/D01_Anatomical/anatSS.sub-S17.nii \
    $output_dir/anatSS.sub-S17

# copy anatomical follower datasets into the results dir
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S17/D01_Anatomical/anatUAC.sub-S17.nii \
    $output_dir/copy_af_anat_w_skull
3dcopy                                                                                           \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/Freesurfer/sub-S17/SUMA/aparc.a2009s+aseg.nii       \
...
3dcopy                                                                                               \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S17/D01_Anatomical/anatQQ.sub-S17.nii      \
...
3dcopy                                                                                               \
    /data/SFIM_Vigilance/PRJ_Vigilance_Smk02/PrcsData/sub-S17/D01_Anatomical/anatQQ.sub-S17_WARP.nii \
    $output_dir/anatQQ.sub-S17_WARP.nii
...
# non-linear warp : anatQQ.sub-S17_WARP.nii
...
foreach run ( $runs )
    ...
    3dNwarpApply -master anatQQ.sub-S17+tlrc -dxyz 3                      \
                 ...
                 -nwarp "anatQQ.sub-S17_WARP.nii mat.r$run.warp.aff12.1D" \
...
3dNwarpApply -master anatQQ.sub-S17+tlrc -dxyz 3                          \
             -source vr_base+orig                                         \
             -nwarp "anatQQ.sub-S17_WARP.nii mat.basewarp.aff12.1D"       \
...
3dNwarpApply -source copy_af_anat_w_skull+orig                            \
             ...
             -ainterp wsinc5 -nwarp anatQQ.sub-S17_WARP.nii               \
             anatQQ.sub-S17.aff12.1D                                      \
             -prefix follow_anat_anat_w_skull
3dNwarpApply -source copy_af_aaseg+orig                                   \
             -master anat_final.$subj+tlrc                                \
             -ainterp NN -nwarp anatQQ.sub-S17_WARP.nii                   \
             anatQQ.sub-S17.aff12.1D                                      \
