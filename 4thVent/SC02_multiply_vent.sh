...
# This script takes the 4th vent mask created in script 1 and multiplies it by the full brain mask of each subject to check if the vent overlays all of the subjects masks
